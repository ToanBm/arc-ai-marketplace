...
import { Languages, FileText, Code, type LucideIcon } from "lucide-react";
...
export default function ServiceCard({ type, active, onClick }: ServiceCardProps) {
  ...
  const { data: quote } = useQuote(type);
